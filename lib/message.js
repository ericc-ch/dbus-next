  ...
  stream.on("readable", function () {
    while (1) {
      if (state === 0) {
        ...
        fieldsLength =
          endian === LE ? header.readUInt32LE(12) : header.readUInt32BE(12)
        fieldsLengthPadded = ((fieldsLength + 7) >> 3) << 3
        bodyLength =
          endian === LE ? header.readUInt32LE(4) : header.readUInt32BE(4)
        ...
        const message = {}
        message.serial =
          endian === LE ? header.readUInt32LE(8) : header.readUInt32BE(8)
