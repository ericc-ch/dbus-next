...
const { Interface, ACCESS_READ, ACCESS_WRITE } = dbus.interface

const { METHOD_CALL, METHOD_RETURN, SIGNAL, ERROR } = dbus.MessageType

const { NO_REPLY_EXPECTED } = dbus.MessageFlag
