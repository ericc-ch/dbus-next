...
const { PRIMARY_OWNER, IN_QUEUE, EXISTS, ALREADY_OWNER } = dbus.RequestNameReply

const { RELEASED, NON_EXISTENT, NOT_OWNER } = dbus.ReleaseNameReply

const { ALLOW_REPLACEMENT, REPLACE_EXISTING, DO_NOT_QUEUE } = dbus.NameFlag
